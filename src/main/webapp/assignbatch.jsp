...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        String username = request.getParameter("user_id"); // This now expects the username as input
        ...
        if (username != null && batch != null) {
            ...
            try {
                ...
                // Update the user's batch using username instead of id
                String query = "UPDATE users SET batch = ? WHERE username = ?";
                ...
                if (updateCount > 0) {
                    ...
                    message = "Failed to assign batch. User not found.";
                }
            } catch (Exception e) {
            ...
            message = "Username and Batch are required.";
        }
    }
%>
<!DOCTYPE html>
